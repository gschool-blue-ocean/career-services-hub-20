  ...
  return (
    <>
      <div className="container">
        ...
        <button className="logoff" onClick={studentInfo.handleLogOff}>
          Sign Out
        </button>
        <div>
          <div className="studentCard">
            ...
            <div className="card-item">
              • Education Level: {currentStudent.college_degree}{" "}
              <p>• Personal Narrative: {currentStudent.personal_narrative} </p>
            </div>
            <div className="card-item">
              • Cohort: {currentStudent.cohort}
              <p>
                • CSM: {currentStudent.tscm_first} {currentStudent.tscm_last}
              </p>
            </div>
            <div className="card-item">
              • LinkedIn: {currentStudent.linkedin}
              <p>• Hunter Account: {currentStudent.hunter_access}</p>
            </div>
            <div className="card-item">
              • Course Standing: {currentStudent.course_status}{" "}
              <p>• Security Clearance: {currentStudent.sec_clearance}</p>
            </div>
            <div className="card-item">
              • Cover Letter: {currentStudent.cover_letter}{" "}
